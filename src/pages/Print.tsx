            ...
            <div className="flex h-screen bg-gray-100">
                ...
                <div className={`flex-1 flex flex-col transition-all duration-300 ease-in-out ${isSidebarOpen ? 'ml-64' : 'ml-20'}`}>
                    ...
                    <main className="flex-1 p-6 overflow-y-auto bg-white">
                        <h1 className="text-3xl font-bold text-gray-800 mb-6">Print Prescription</h1>
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div ref={printRef} className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                                <img 
                                    src="/rx-prescription.png" 
                                    alt="Rx Prescription" 
                                    className="max-w-full h-auto"
                                    style={{ maxWidth: '210mm', maxHeight: '297mm' }} // A4 size
                                />
                            </div>
                            
                            <p className="text-gray-500 mt-4 text-center">
                                Click the print button above to print the Rx prescription
                            </p>
                        </div>
                    </main>
                </div>
